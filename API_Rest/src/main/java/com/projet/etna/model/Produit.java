...
public class Produit {
	...
	public Produit (Integer id, String ref, Double price, String name, String info, Integer nb, String lien, User uti, Date add, Date modif) {
		this.id = id;
		this.reference = ref;
		this.prix = price;
		this.nom = name;
	...
	public Produit (String ref, Double price, String name, String info, Integer nb, String lien, User uti, Date add, Date modif) {
		this.reference = ref;
		this.prix = price;
		this.nom = name;
		this.description = info;
