...
public class User {
	...
	public User(Integer id,String name, String pass, UserRole role, Date add, Date modif) {
		this.id = id;
		this.username = name;
		this.password = pass;
		this.userRole = role;
	...
	public User(String name, String pass, UserRole role, Date add, Date modif) {
		this.username = name;
		this.password = pass;
		this.userRole = role;
		this.creationDate = add;
	...
	public String toString() {
		String toString = String.format("\n[id=%s, username=%s, password=%s, userRole=%s, creationDate=%s, updateUser=%s ", id,username,password,userRole,creationDate,updatedDate);
