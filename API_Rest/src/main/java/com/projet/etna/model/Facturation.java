...
public class Facturation {
	...
	public Facturation(Integer id, Integer tQt, Double tPrix, Payement paye, Livraison send, Panier basket, Adresse addre, Date add, Date modif) {
		this.id = id;
		this.totalQt = tQt;
	...
	public Facturation(Integer tQt, Double tPrix, Payement paye, Livraison send, Panier basket, Adresse addre, Date add, Date modif) {
		this.totalQt = tQt;
		this.totalPrix = tPrix;
		this.payement = paye;
		this.livraison = send;
	...
	public String toString() {
		String toString = String.format("\n[id=%s, totQt=%s, totPrix=%s, payement=%s, livraison=%s, panier=%s, adresse=%s, creationDate=%s, updatedDate=%s", id, totalQt, totalPrix, payement, livraison, panier.toString(), adresse.toString(), creationDate, updatedDate);
