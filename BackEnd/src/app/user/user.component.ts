...
export class UserComponent implements OnInit {
  ...
  constructor(private userService: UserService, private token: SaveTokenService, private router: Router, private adresseService: AdresseService,
              // tslint:disable-next-line: max-line-length
  ...
  deleteUser(user: User): void {
    ...
    this.adresseService.deleteAdresseByUser(user.id)
      .subscribe( data => {
         console.log(data);
    });
